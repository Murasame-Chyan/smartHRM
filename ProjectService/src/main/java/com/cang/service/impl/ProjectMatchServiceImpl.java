...
import com.cang.entity.Project;
import com.cang.entity.Task;
import com.cang.entity.dao.EmployeeRepo;
import com.cang.entity.dao.ProjectRepo;
import com.cang.entity.dao.TaskRepo;
import com.cang.entity.dto.ProjectDTO;
import com.cang.service.ProjectMatchService;
...
public class ProjectMatchServiceImpl implements ProjectMatchService {
    ...
    private boolean isEmployeeSkillsMatchProject(Project project, List<Integer> employeeSkills) {
        ...
        Set<Integer> projectRequiredSkills = project.getReqSkill().stream()
                .map(Project.ReqSkill::getSkillId)
                .collect(Collectors.toSet());

        return employeeSkills.stream()
                .anyMatch(projectRequiredSkills::contains);
    }
